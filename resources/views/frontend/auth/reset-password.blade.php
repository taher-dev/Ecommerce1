                    ...
                    <div class="col-xl-6 col-lg-8 col-md-12 m-auto">
                        <div class="row">
                            <div class="heading_s1">
                                <img class="border-radius-15" src="{{ asset('assets/imgs/page/reset_password.svg') }}" alt="Reset Password" />
                                    ...
                                    <div class="padding_eight_all bg-white">
                                        <form method="POST" action="{{ route('password.update') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required name="email" placeholder="Email *" autofocus autocomplete="username" value="{{ old('email', $request->email) }} />
                                            </div>
                                            <div class="form-group">
                                                <input type="password" required name="password" placeholder="Password *" autocomplete="new-password" />
                                            </div>
                                            <div class="form-group">
                                                <input type="password" required name="password_confirmation" placeholder="Confirm you password *" autocomplete="new-password" />
                                            </div>
                                            <div class="form-group">
